...
ICOS-FL: Flower-powered FL framework for real-time resource monitoring (LSTM) & predictions. Modular architecture for custom AI models + private distributed training.


* GitHub repo: <https://github.com/anaskalt/icos-fl.git>
* Documentation: <https://icos-fl.readthedocs.io>
* Free software: MIT
